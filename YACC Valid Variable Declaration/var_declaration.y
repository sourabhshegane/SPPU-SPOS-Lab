...
;
type1:INT varlist SC NL { printf("Above Variable Declaration is Valid"); return 0;}

;
type2:FLOAT varlist2 SC NL{ printf("Above Variable Declaration is Valid");return 0;}
;
type3:CHAR varlist3 SC NL{ printf("Above Variable Declaration is Valid");return 0;}
;
type4:BL varlist4 SC NL{ printf("Above Variable Declaration is Valid");return 0;}
;
